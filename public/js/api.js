...
export const api = {
  ...
  adminLibraryAccess: () => call('GET', '/api/admin/library-access'),   // t123
  adminSetLibraryAccess: (key, value) => call('PUT', '/api/admin/library-access', { key, value }),   // t123
  adminInvites: () => call('GET', '/api/admin/invites'),                 // t123
  adminTailscaleIp: () => call('GET', '/api/admin/tailscale-ip'),        // t123
  adminRetheme: (theme) => call('POST', '/api/admin/retheme', { theme }), // t132
