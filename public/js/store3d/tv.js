...
import { signTexture, hashString } from './textures.js?v=1788905515415';
import { computeTheaterSpeakers } from './room.js?v=1788905515415';   // 8.2 layout (shared with the room mesh)
