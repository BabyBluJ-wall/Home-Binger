...
import { LAYOUT } from './config.js?v=1788852958324';
import { signTexture, hashString } from './textures.js?v=1788852958324';
import { computeTheaterSpeakers } from './room.js?v=1788852958324';   // 8.2 layout (shared with the room mesh)
