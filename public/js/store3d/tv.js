...
import { signTexture, hashString } from './textures.js?v=1788996243385';
import { computeTheaterSpeakers } from './room.js?v=1788996243385';   // 8.2 layout (shared with the room mesh)
