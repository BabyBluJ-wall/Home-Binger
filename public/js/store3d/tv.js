...
import { signTexture, hashString } from './textures.js?v=1788899102183';
import { computeTheaterSpeakers } from './room.js?v=1788899102183';   // 8.2 layout (shared with the room mesh)
