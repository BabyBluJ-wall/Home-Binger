...
import { signTexture, hashString } from './textures.js?v=1788937971857';
import { computeTheaterSpeakers } from './room.js?v=1788937971857';   // 8.2 layout (shared with the room mesh)
