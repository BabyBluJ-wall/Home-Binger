...
import { signTexture, hashString } from './textures.js?v=1788729356586';
import { computeTheaterSpeakers } from './room.js?v=1788729356586';   // 8.2 layout (shared with the room mesh)
