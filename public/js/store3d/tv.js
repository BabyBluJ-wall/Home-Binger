...
import { signTexture, hashString } from './textures.js?v=1788919797230';
import { computeTheaterSpeakers } from './room.js?v=1788919797230';   // 8.2 layout (shared with the room mesh)
