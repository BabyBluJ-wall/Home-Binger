...
import { signTexture, hashString } from './textures.js?v=1788810462055';
import { computeTheaterSpeakers } from './room.js?v=1788810462055';   // 8.2 layout (shared with the room mesh)
